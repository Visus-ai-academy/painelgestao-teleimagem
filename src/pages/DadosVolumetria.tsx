    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Upload e processamento dos dados MobileMed com regras automáticas v002, v003, v031
        </p>
      </div>
          ...
          <TabsContent value="upload" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Análise de exames que não foram identificados no processamento</CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ol className="list-decimal list-inside text-amber-700 text-sm space-y-1">
                    ...
                    <li>
                      <strong>Executar 28 Regras Completas</strong> - Aplica normalização, categorias, especialidades e
                      modalidades
                    </li>
                    <li>
                      <strong>Aplicar Agrupamento de Clientes</strong> - Distribui exames para clientes derivados (ex:
                      CEMVALENCA_RX)
                    </li>
                    <li>
                      <strong>Aplicar Tipificação Geral</strong> - Define tipo de faturamento (CO-FT, NC-FT, etc.) -{" "}
                      <span className="font-bold">SEMPRE POR ÚLTIMO</span>
                    </li>
                  </ol>
