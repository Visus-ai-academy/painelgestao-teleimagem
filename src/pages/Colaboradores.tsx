    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="gestao" className="w-full">
        <TabsList>
          ...
          <TabsTrigger value="cadastro">Cadastro Novo Médico</TabsTrigger>
          <TabsTrigger value="comparativo">Comparativo de Nomes</TabsTrigger>
        </TabsList>

        {/* ABA: Cadastro Novo Médico */}
        <TabsContent value="cadastro" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">
                  Importar ou cadastrar novos médicos
                </p>
              </CardHeader>
            ...
            {/* Seção: Templates Cadastro Médicos */}
            <Card>
              <CardHeader>
                <CardTitle>Templates Cadastro Médicos</CardTitle>
                <p className="text-sm text-muted-foreground">
                  Baixe os templates para importação
                </p>
              </CardHeader>
              <CardContent className="space-y-3">
                <DownloadTemplateNovosMedicos />
                <DownloadTemplateCadastroMedico />
              </CardContent>
            </Card>
          </div>
        </TabsContent>
