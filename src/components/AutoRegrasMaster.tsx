...
const REGRAS_SISTEMA = [
  {
    ...
    categoria: "Temporal",
    criterio:
      'Impede edição de dados com mais de 5 dias do mês anterior. Bloqueia inserção de dados futuros. Inclui botão de "fechar faturamento" que bloqueia novos dados após fechamento.',
  ...
  },
  {
    ...
    categoria: "Exclusão",
    criterio:
      "Remove registros com DATA_LAUDO fora do período de faturamento (dia 8 do mês até dia 7 do mês seguinte). Aplicada SOMENTE nos arquivos: volumetria_padrao_retroativo e volumetria_fora_padrao_retroativo.",
  ...
  },
  {
    ...
    categoria: "Exclusão",
    criterio:
      "Remove registros com DATA_REALIZACAO fora do mês de referência (01 ao último dia) e DATA_LAUDO fora do período permitido. Aplicada SOMENTE nos arquivos: volumetria_padrao, volumetria_fora_padrao e volumetria_onco_padrao.",
  ...
  },
  {
    ...
    criterio:
      'Todos os exames na coluna ESTUDO_DESCRICAO que começam com "RX " têm a modalidade alterada para "RX". Aplica-se aos arquivos de upload 1,2,3,4,5.',
  ...
  },
  {
    ...
    categoria: "Dados",
    criterio:
      'Substitui o campo EMPRESA (nome_mobilemed que vem dos arquivos 1,2,3,4) pelo nome_fantasia cadastrado na tabela clientes. O nome original vira "Unidade_Origem".',
  ...
  },
  {
    ...
    categoria: "Dados",
    criterio:
      'Corrige especialidades inconsistentes: "Colunas" → "MUSCULO ESQUELETICO" e "ONCO MEDICINA INTERNA" → "MEDICINA INTERNA".',
  ...
  },
  {
    ...
    criterio:
      "Aplica mapeamento de prioridades usando tabela valores_prioridade_de_para para padronizar valores de prioridade.",
  ...
  },
  {
    ...
    categoria: "Exclusão",
    criterio:
      "Aplica regras de exclusão configuradas dinamicamente baseadas em critérios JSON (empresa, modalidade, especialidade, categoria, médico).",
  ...
  },
  {
    ...
    categoria: "Dados",
    criterio:
      "Define data de referência baseada no período de processamento selecionado para garantir consistência temporal dos dados.",
  ...
  },
  {
    ...
    categoria: "Exclusão",
    criterio:
      "Exclui registros de clientes específicos: RADIOCOR_LOCAL, CLINICADIA_TC, CLINICA RADIOCOR, CLIRAM_LOCAL.",
  ...
  },
  {
    ...
    categoria: "Dados",
    criterio:
      'Para exames com especialidades "Cardio com Score", "Corpo" ou "Onco Medicina Interna", substitui pelos valores do cadastro_exames baseado no nome do exame.',
  ...
  },
  {
    ...
    categoria: "Dados",
    criterio:
      'Exames com especialidade "Colunas" viram "Músculo Esquelético", exceto para 43 médicos específicos que viram "Neuro". Normalização inteligente de nomes.',
  ...
  },
  {
    ...
    criterio:
      'Define tipificação para 10 clientes NC: CDICARDIO, CDIGOIAS, CISP, etc. NC-FT para CARDIO, PLANTÃO, ou estudos específicos ("ANGIOTC VENOSA TORAX CARDIOLOGIA", "RM CRANIO NEUROBRAIN").',
  ...
  },
  {
    ...
    categoria: "Faturamento",
    criterio:
      "Define tipificação para 3 clientes NC adicionais: CEMVALENCA, RMPADUA, RADI-IMAGEM. NC-FT para CARDIO/MEDICINA INTERNA/NEUROBRAIN, PLANTÃO, 29 médicos específicos.",
  ...
  },
  {
    ...
    categoria: "Faturamento",
    criterio:
      "Regra removida. Tipificação é feita APENAS pela função aplicar-tipificacao-faturamento com tipos válidos: CO-FT, CO-NF, NC-FT, NC-NF, NC1-NF.",
    implementacao: "Edge function: aplicar-tipificacao-faturamento",
  },
  {
    id: "v026",
    ...
    categoria: "Sistema",
    criterio:
      "Sistema monitora uploads concluídos e aplica automaticamente todas as 28 regras anteriores via trigger otimizado.",
  ...
  },
  {
    ...
    categoria: "Sistema",
    criterio:
      "Executa validação final dos dados processados e registra todas as aplicações de regras no audit_logs para rastreabilidade completa.",
  ...
  },
  {
    ...
    categoria: "Especialidade",
    criterio:
      'Corrige ESPECIALIDADE de "MAMA" para "MAMO" quando MODALIDADE é "MG". MAMA é reservado para RM MAMAS (modalidade MR), mamografias devem usar MAMO.',
    implementacao: "Edge function: aplicar-27-regras-completas",
  },
];
  ...
  const aplicarRegrasAutomaticamente = async (uploadData: any) => {
    ...
    try {
      ...
      if (data?.success) {
        ...
        toast.success(
          `✅ Regras aplicadas automaticamente! ${totalCorrecoes} correções em ${totalProcessados} registros`,
        );
        ...
        <div className="mt-4 space-y-4">
          <div className="p-3 bg-muted rounded-lg">
            <p className="text-sm text-muted-foreground">
              <strong>Funcionamento:</strong> O sistema monitora automaticamente todos os uploads de volumetria e aplica
              instantaneamente as 28 regras de negócio. Não requer intervenção manual.
            </p>
          </div>
