-- Criar função para calcular faturamento completo incluindo franquias
...
BEGIN
  ...
  -- Calcular valor dos exames (será calculado externamente)
  v_valor_exames := 0; -- Placeholder - será calculado na aplicação
...
-- Sincronizar parâmetros de faturamento para contratos
...
BEGIN
  ...
  VALUES ('contratos_clientes', 'SYNC_PARAMETROS', 'bulk', 
          jsonb_build_object('contratos_atualizados', v_atualizados),
          'system', 'info');
