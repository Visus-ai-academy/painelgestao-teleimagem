-- Corrigir função aplicar_quebras_pendentes sem audit_logs
...
BEGIN
  ...
  LOOP
    ...
    LOOP
      -- Calcular valor quebrado - usando valor fixo de 1 para cada exame quebrado
      valor_quebrado := 1;
...
-- Aplicar quebras pendentes agora
SELECT aplicar_quebras_pendentes('volumetria_padrao');