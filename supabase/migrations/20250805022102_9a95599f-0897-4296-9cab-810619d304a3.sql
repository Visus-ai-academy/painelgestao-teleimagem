-- FUNÇÃO DEFINITIVA PARA CARREGAR TODOS OS DADOS DA VOLUMETRIA SEM LIMITAÇÃO
...
-- FUNÇÃO PARA ESTATÍSTICAS DASHBOARD COMPLETAS
...
BEGIN
  ...
  percentual_atraso_calc := CASE 
    WHEN total_registros_calc > 0 THEN 
      ROUND((total_atrasados_calc * 100.0 / total_registros_calc), 2)
    ELSE 0
  END;
