-- Limpar funções existentes para recriar
DROP FUNCTION IF EXISTS public.processar_tasks_sistema();
DROP FUNCTION IF EXISTS public.trigger_auto_aplicar_regras();
