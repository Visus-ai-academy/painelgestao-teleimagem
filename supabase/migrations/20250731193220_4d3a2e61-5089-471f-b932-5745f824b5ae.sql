-- Desabilitar completamente o trigger que está causando problemas
DROP TRIGGER IF EXISTS sync_field_mappings_trigger ON field_mappings;

-- Remover a função problemática também
DROP FUNCTION IF EXISTS public.sync_field_mappings();

-- Agora fazer as atualizações sem triggers
