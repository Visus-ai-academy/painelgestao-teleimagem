...
-- Preços de Serviços
('precos_servicos_teste.xlsx', 'precos_servicos', 'configuracao', 'concluido', 120, 80, 35, 5, NOW() - INTERVAL '5 hours'),
-- Regras de Exclusão
('regras_exclusao_teste.xlsx', 'regras_exclusao', 'configuracao', 'concluido', 45, 40, 5, 0, NOW() - INTERVAL '6 hours'),
-- Repasse Médico
('repasse_medico_teste.xlsx', 'repasse_medico', 'configuracao', 'concluido', 60, 55, 5, 0, NOW() - INTERVAL '7 hours'),
-- Categorias de Exame
