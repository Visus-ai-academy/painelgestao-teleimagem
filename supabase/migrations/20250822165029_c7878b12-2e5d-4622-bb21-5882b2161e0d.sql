-- Criar regras de exclusão para teste e configurar triggers

-- 1. Criar regras de exclusão para os testes
...
-- 2. Configurar triggers na tabela volumetria_mobilemed
-- Trigger para aplicar regras de exclusão dinâmicas
...
-- 3. Verificar se a tabela de regras existe, senão criar
