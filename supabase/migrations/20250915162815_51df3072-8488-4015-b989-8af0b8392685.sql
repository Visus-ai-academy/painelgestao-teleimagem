-- Corrigir função calcular_preco_exame para usar ordenação correta de volume
...
BEGIN
  ...
  ORDER BY 
    ...
    CASE 
      ...
      ELSE 3
    END,
    -- CORREÇÃO CRÍTICA: Ordenar volume_inicial ASC para pegar a menor faixa aplicável
    ps.volume_inicial ASC NULLS FIRST
  LIMIT 1;
