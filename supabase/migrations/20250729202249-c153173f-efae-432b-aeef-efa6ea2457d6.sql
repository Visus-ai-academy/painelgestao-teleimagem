...
CREATE TABLE public.processamento_uploads (
...
CREATE INDEX idx_processamento_uploads_tipo_arquivo ON public.processamento_uploads(tipo_arquivo);
CREATE INDEX idx_processamento_uploads_status ON public.processamento_uploads(status);
CREATE INDEX idx_processamento_uploads_created_at ON public.processamento_uploads(created_at DESC);

-- Trigger para atualizar updated_at
CREATE TRIGGER update_processamento_uploads_updated_at
  BEFORE UPDATE ON public.processamento_uploads
  FOR EACH ROW
