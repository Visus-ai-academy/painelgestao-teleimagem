-- Corrigir função para usar APENAS nome_fantasia, sem extrair da descrição
...
BEGIN
  ...
  resultado := jsonb_build_object(
    ...
    'criterio_busca', 'nome_fantasia exclusivamente (com limpeza de caracteres e logs detalhados)'
  );
