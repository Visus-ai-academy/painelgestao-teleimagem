...
-- Volumetria (tabela mais consultada) - usando nomes corretos das colunas
...
CREATE INDEX IF NOT EXISTS idx_volumetria_data_laudo ON volumetria_mobilemed("DATA_LAUDO");
CREATE INDEX IF NOT EXISTS idx_volumetria_data_realizacao ON volumetria_mobilemed("DATA_REALIZACAO");

-- Índice composto para queries de atraso
CREATE INDEX IF NOT EXISTS idx_volumetria_atraso ON volumetria_mobilemed("DATA_LAUDO", "HORA_LAUDO", "DATA_PRAZO", "HORA_PRAZO");
