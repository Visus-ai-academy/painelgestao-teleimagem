...
DROP POLICY IF EXISTS "Todos podem ver tipos de ausência ativos" ON tipos_ausencia;
DROP POLICY IF EXISTS "Admins podem gerenciar tipos ausência" ON tipos_ausencia;

-- Melhorar estrutura da tabela escalas_medicas (apenas novas colunas)
