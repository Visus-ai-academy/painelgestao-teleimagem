-- Ajuste na função limpar_dados_ficticios: corrigir bloco condicional dos médicos sem EXECUTE
...
BEGIN
  ...
  -- 8. Limpar médicos fictícios (sem referenciar created_by se coluna não existir)
  SELECT EXISTS (
