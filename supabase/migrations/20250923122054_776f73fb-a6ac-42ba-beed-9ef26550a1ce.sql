-- Dropar as 3 versões específicas da função calcular_preco_exame
...
DROP FUNCTION IF EXISTS public.calcular_preco_exame(uuid, text, text, text, text, integer, boolean, text);
